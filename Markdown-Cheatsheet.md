...
4. And another item.  
   ...
   Some text that should be aligned with the above item. Two trailing spaces on a line in a list will insert a line break and keep the next line within the same list item.
